-- Seed: 1 item per category for Lease marketplace (v3 pricing)
...
BEGIN
  ...
  -- Electronics — MacBook Pro M2 14", MRV ₹1,50,000, Mint
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Electronics' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'MacBook Pro M2 14"', 'High-performance laptop perfect for coding, design, and entertainment.', v_cat_id, v_city_id, 0, 0, 150000, 'Mint', 'B', 'active', true)
  ...
  -- Furniture — Ergonomic Office Chair, MRV ₹12,000, Good
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Furniture' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'Ergonomic Office Chair', 'Comfortable mesh back chair with lumbar support. Perfect for long study sessions.', v_cat_id, v_city_id, 0, 0, 12000, 'Good', 'B', 'active', true)
  RETURNING id INTO v_item_id;
  INSERT INTO item_images (item_id, image_url, is_primary, alt_text)
  ...
  -- Books — Engineering Mathematics Bundle, MRV ₹5,000, Good
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Books' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'Engineering Mathematics Bundle', 'Complete set of engineering mathematics textbooks.', v_cat_id, v_city_id, 0, 0, 5000, 'Good', 'B', 'active', true)
  RETURNING id INTO v_item_id;
  INSERT INTO item_images (item_id, image_url, is_primary, alt_text)
  ...
  -- Sports — Badminton Racket Set, MRV ₹3,000, Good
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Sports' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'Badminton Racket Set', 'Professional grade badminton set with 2 rackets and shuttlecocks.', v_cat_id, v_city_id, 0, 0, 3000, 'Good', 'B', 'active', true)
  RETURNING id INTO v_item_id;
  INSERT INTO item_images (item_id, image_url, is_primary, alt_text)
  ...
  -- Kitchen — Induction Cooktop 2000W, MRV ₹5,000, Good
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Kitchen' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'Induction Cooktop 2000W', 'Portable induction cooktop with 8 power levels and automatic shut-off.', v_cat_id, v_city_id, 0, 0, 5000, 'Good', 'B', 'active', true)
  RETURNING id INTO v_item_id;
  INSERT INTO item_images (item_id, image_url, is_primary, alt_text)
  ...
  -- Clothing — Premium Winter Jacket, MRV ₹4,000, Good
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Clothing' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'Premium Winter Jacket', 'Warm insulated winter jacket. Perfect for cold campus mornings. Size M.', v_cat_id, v_city_id, 0, 0, 4000, 'Good', 'B', 'active', true)
  RETURNING id INTO v_item_id;
  INSERT INTO item_images (item_id, image_url, is_primary, alt_text)
  ...
  -- Other — Acoustic Guitar Beginner, MRV ₹5,000, Good
  SELECT id INTO v_cat_id FROM categories WHERE name = 'Other' LIMIT 1;
  INSERT INTO items (seller_id, title, description, category_id, city_id, monthly_rent, deposit_amount, retail_price, condition, seller_type, status, is_available)
  VALUES (v_seller_id, 'Acoustic Guitar Beginner', '6-string acoustic guitar perfect for beginners. Includes carrying case.', v_cat_id, v_city_id, 0, 0, 5000, 'Good', 'B', 'active', true)
  RETURNING id INTO v_item_id;
  INSERT INTO item_images (item_id, image_url, is_primary, alt_text)
  ...
  RAISE NOTICE 'Done! 7 items seeded with v3 pricing (retail_price set, condition, seller_type)';
END $$;
