...
<section className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-gray-800 to-gray-900 p-8 md:p-16 text-white shadow-2xl opacity-80">
  <div className="relative z-10 text-center">
    ...
    <div className="flex justify-center gap-2 mt-8">
      <div className="w-3 h-3 rounded-full bg-yellow-400 animate-bounce" style="animation-delay: 0s" />
      <div className="w-3 h-3 rounded-full bg-yellow-400 animate-bounce" style="animation-delay: 0.15s" />
      <div className="w-3 h-3 rounded-full bg-yellow-400 animate-bounce" style="animation-delay: 0.3s" />
    </div>
  </div>
