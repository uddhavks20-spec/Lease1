...
const popularItemsMock = [
  { name: "Split AC 1.5 Ton", slug: "air-conditioners", img: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=800", price: "₹1200/mo", badge: "5-Star Inverter" },
  { name: "Smart TV 43\"", slug: "televisions", img: "https://images.unsplash.com/photo-1593305841991-05c297ba4575?auto=format&fit=crop&q=80&w=800", price: "₹800/mo", badge: "4K UHD" },
  { name: "3-Seater Sofa", slug: "study-furniture", img: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&q=80&w=800", price: "₹600/mo", badge: "Solid Wood" },
  { name: "MacBook Pro M2", slug: "laptops-electronics", img: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&q=80&w=800", price: "₹2500/mo", badge: "Mint Condition" },
]

const categoryTiles = [
  { name: "Air Conditioners", slug: "air-conditioners", img: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=800" },
  { name: "Televisions", slug: "televisions", img: "https://images.unsplash.com/photo-1593305841991-05c297ba4575?auto=format&fit=crop&q=80&w=800" },
  { name: "Laptops & Electronics", slug: "laptops-electronics", img: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&q=80&w=800" },
